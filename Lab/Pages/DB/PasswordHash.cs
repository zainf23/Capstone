...
namespace Lab.Pages.DB
{
    public class PasswordHash
    {
        ...
        public static string HashPassword(string passphrase)
        {
            ...
            var hash = GetPbkdf2Bytes(passphrase, salt, Pbkdf2Iterations, HashByteSize); // call method below to create the hash
        ...
        private static byte[] GetPbkdf2Bytes(string passphrase, byte[] salt, int iterations, int outputBytes)
        {
            var pbkdf2 = new Rfc2898DeriveBytes(passphrase, salt); // create a new key
        ...
        public static bool ValidatePassword(string passphrase, string correctHash)
        {
            ...
            var testHash = GetPbkdf2Bytes(passphrase, salt, iterations, hash.Length); // creates the hash for the entered password
